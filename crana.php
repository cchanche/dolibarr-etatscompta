...
/* Début du propre de la page */


include('include/include.php') ;

$listecodeana=lister_code_ana($bdd,$_SESSION['periode'],$_SESSION['plan_comptable'],$preg="^[6-7]") ;


//tableau des charges
echo '<h1>' . $titre_du_site . '</h1>' 
        . '<h3>Du ' . $_SESSION['periode'][0]->format('j/m/Y') .' Au '  .  $_SESSION['periode'][1]->format('j/m/Y') . '</h3>' ;  
echo "<h2>Compte de resultat analityque</h2>" ;
        
        
foreach($listecodeana as $codeana)
{
...
$listecomptecharge=lister_compte_ana($bdd,$_SESSION['periode'],$_SESSION['plan_comptable'],$codeana,$preg="^[6]") ;
$listecompteproduit=lister_compte_ana($bdd,$_SESSION['periode'],$_SESSION['plan_comptable'],$codeana,$preg="^[7]") ;



echo "<h3>Code analityque " . $codeana . "</h3>
<div id=\"global\"><div id=\"gauche\"><table border=4 cellpading=50 align=center><h3>Charges</h3>" ;
...
echo '<div id="pied"><h2>Résultat :  ' . $resultat . "  €</h2></div><hr>";
