...
/**
 *	\file       etatscompta/etatscomptaindex.php
 *	\ingroup    etatscompta
 *	\brief      Home page of etatscompta top menu
 */
...
$langs->loadLangs(array("etatscompta@etatscompta"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->etatscompta->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("EtatsComptaArea"));

print load_fiche_titre($langs->trans("EtatsComptaArea"), '', 'etatscompta.png@etatscompta');
...
// Draft MyObject
if (! empty($conf->etatscompta->enabled) && $user->rights->etatscompta->read)
{
	$langs->load("orders");
