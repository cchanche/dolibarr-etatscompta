...
/**
 * \file    test/phpunit/EtatsComptaFunctionalTest.php
 * \ingroup etatscompta
...
/**
 * Class EtatsComptaFunctionalTest
 *
 ...
 *
 * @package Testetatscompta
 */
class EtatsComptaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEtatsCompta')->click();
		} else {
			// Disable the module
			$this->byHref('modEtatsCompta')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/etatscompta/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('etatscompta/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/etatscompta/admin/about.php');
		$this->authenticate();
		return $this->assertContains('etatscompta/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('etatscomptawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEtatsCompta_EtatsComptaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEtatsCompta_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
