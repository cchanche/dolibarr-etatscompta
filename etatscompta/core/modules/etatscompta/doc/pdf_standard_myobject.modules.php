...
/**
 *  \file       etatscompta/core/modules/etatscompta/doc/pdf_standard.modules.php
 *  \ingroup    etatscompta
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->etatscompta->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->etatscompta->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->etatscompta->dir_output.'/myobject/'.$objectref;
